...
long long coeff(long long i_n, long long i_m, long long i_mod)
{
    if (i_m == 0)
    {
        return 1LL;
    ...
    long long num = fact_mod(i_n + i_m - 2, i_mod);
    long long den = fact_mod(i_n - 1, i_mod) * fact_mod(i_m - 1, i_mod) % i_mod;
